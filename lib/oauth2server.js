...
var error = require('./error'),
  ...
  Grant = require('./grant'),
  PreApprovedGrant = require('./preApprovedGrant');
...
/**
 * Pre ApprovedGrant in-memory middleware
 *
 * @return {Function} middleware
 */
OAuth2Server.prototype.preApprovedGrant = function () {
  var self = this;

  return function (preApproved, next) {
    new PreApprovedGrant(self, preApproved, next);
  };
};
